...
public class AgendamentoService {
	...
	public List<AgendamentoDto> findAll() {
		return agendamentoRepository.findAll().stream()
				.map(agendamento -> new AgendamentoDto(agendamento.getId(), agendamento.getUsuario().getId(),
						agendamento.getUsuario().getNome(), agendamento.getUsuario().getEmail(),
	...
	public Agendamento save(SaveAgendamentoDto saveAgendamentoDto) {
		...
		Usuario usuario = usuarioRepository.findById(saveAgendamentoDto.getId()).orElseThrow(
				() -> new RuntimeException("Usuário com ID " + saveAgendamentoDto.getId() + " não encontrado."));
		...
		try {
			...
			emailService.enviarEmailSimples(usuario.getEmail(), "Confirmação de Agendamento",
					agendamento.getDataHora());
